...
<link rel="stylesheet" href="css/style.css" />
	 ...
	 */
		$("#query").click(function() {
				        ...
				        var params = [{"name" : "adminID","value" : staffID}
				                     ,{"name" : "adminName","value" : staffName}
				                     ];
...
<body style="width:1100px;" >
 ...
 <div id="gridCXEE">
<table id="gridTable" style="width:800px;"></table>
</div>
</body>
</html>