...
<body style="width:850px;" >
	<form action="exportFinanceExcel.do" name="memberForm" id="memberForm" target="result"
			method="post">
...
<!-- 			</td> -->
			<th></th>
			<td><label id="memberInfo_startDate">开始日期:</label>
			    <input type="text" name="startDate" id="startDate" class="input_txt" onClick="WdatePicker()" maxlength=20 value="${editMember.birthDate}" />
			</td>
			<td>
			    <label id="memberInfo_endDate">结束日期:</label>
			    <input type="text" name="endDate" id="endDate" class="input_txt" onClick="WdatePicker()" maxlength=20 value="${editMember.birthDate}" />
			</td>
			<td style="width:auto;">
				<input id="query" type="button" value="查询" style="margin-left:5px; padding: .2em;">
                <input id="export" type="submit" value="导出" style="margin-left:5px; padding: .2em;">
            </td>
        </tr>
        </table>
	</form>
 ...
 <div id="gridCXEE">
<table id="gridTable" style="width:850px;"></table>
</div>
</body>
</html>