	...
	<div class="pageall">
		<div class="pageall_r">
			<div class="pageall_r_top">
				<div class="pagetitle" id="m_title">联系医生</div>
		...
		<div class="pageall_l">
			<div class="pageall_l_top">
				<div class="yellow">医患交互</div>
				<div class="grey">Contact US</div>
			</div>
			<div class="pageall_l_sidebar">
				<ul>
									<li><a id="type57" href="contactUsView.do">联系医生</a></li>
								</ul> 
			</div>
...
<div class="bot">
<div class="bottom_r">
<p style="font-family: Microsoft YaHei;margin-right: 50px">Copyright©2017 All Rights Reserved.锦州市古塔区医养服务中心版权所有<br />公司地址：锦州市东二里53号 </p>
</div>
