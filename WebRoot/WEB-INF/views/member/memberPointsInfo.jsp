...
.info td {
	...
	<body>
		<form action="confirmAddPoints.do" name="memberForm" id="memberForm" target="result"
			...
			<table border="0" cellpadding="0" cellspacing="0">
				...
				<tr class="info">
					<th><label id="memberInfo_totalPoints">增加积分数:</label></th>
					<td><input type="text" name="changePoints" id="changePoints" class="input_txt" maxlength=20 />
					<label style="color:red;">*</label>
					</td>
				</tr>
				<tr class="info">
					<th><label id="memberInfo_totalPoints">增加积分理由:</label></th>
