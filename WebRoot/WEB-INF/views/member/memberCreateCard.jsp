...
<link rel="stylesheet" href="css/style.css" />
	 ...
	 */
		...
		$("#edit").click(function() {
		    ...
		    {alert("选择一个会员进行建卡!");}
			    ...
			    var dg = new $.dialog({
			        ...
			        xButton:true,
			        resize:false,
			        page:'editMemberForCreateCard.do?memberID='+ids
			    });
				dg.ShowDialog();
			}
		});
		...
		$("#gridTable").flexigrid({
			...
			url : 'listMemberForCreateCard.do',
			dataType : 'json',
			colModel : [ 
			 {
				display : '会员ID',
...
<!--                 <input id="add" type="button" value="增加" style="margin-left:5px; padding: .2em;"> -->
                <input id="edit" type="button" value="会员建卡" style="margin-left:5px; padding: .2em;">
<!--                 <input id="reAdd" type="button" value="会员卡补发" style="margin-left:5px; padding: .2em;"> -->
