...
<link rel="stylesheet" href="css/style.css" />
	 ...
	 */
		...
		$("#edit").click(function() {
		    ...
		    {alert("选择一个会员进行建卡!");}
			    ...
			    var dg = new $.dialog({
			        ...
			        xButton:true,
			        resize:false,
			        page:'editMemberForRecreateCard.do?memberID='+ids
			    });
				dg.ShowDialog();
			}
		});
		...
		$("#delete").click(function() {
		    ...
		    if (confirm("确定删除会员[" + name + "]?")) {
				$.ajax({ 
				        type: "post", 
				        url: "deleteMembers.do?ids="+ids,
				        dataType: "json", 
		...
		$("#gridTable").flexigrid({
			...
			url : 'listMemberForReCreateCard.do',
			dataType : 'json',
			colModel : [ 
			 {
				display : '会员ID',
...
<!--                 <input id="add" type="button" value="增加" style="margin-left:5px; padding: .2em;"> -->
                <input id="edit" type="button" value="补发会员卡" style="margin-left:5px; padding: .2em;">
<!--                 <input id="reAdd" type="button" value="补发会员卡" style="margin-left:5px; padding: .2em;"> -->
<!--                 <input id="delete" type="button" value="删除" style="margin-left:5px; padding: .2em;"> -->
 ...
 <div id="gridCXEE">
<table id="gridTable" style="width:1150px;"></table>
</div>
</body>
</html>